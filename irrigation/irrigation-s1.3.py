...
humidityIntervalEntry.insert(END,'2')
...
distanceTimingEntry.insert(END,'06:00:00 , 20:00:00')
...
def LogEvent(incomingData):
    ...
    logEventFile = open('Log_Event.txt','a')
