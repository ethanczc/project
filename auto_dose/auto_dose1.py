...
startDateEntry.insert(END,'22/9/2018')
...
waterTankParameters_Label = Label(root,text='TANK PARAMETERS').grid(row=5,column=0,columnspan=2)

waterTankSize_Set = Label(root,text='Set Tank size (mL)').grid(row=6,column=0)
waterTankSize_Entry = Entry(root)
waterTankSize_Entry.grid(row=6,column=1)
waterTankSize_Entry.insert(END,'10000')

waterTankSize_Label = Label(root,text='Tank Size (mL)').grid(row=7,column=0)
waterTankSize_Display = Label(root,text='')
waterTankSize_Display.grid(row=7,column=1)
...
waterTankSize_Button.grid(row=8,column=0,columnspan=2)
...
ecStage1Target_Entry.insert(END,'0.8')
...
ecStage1Target, ecStage2Target, ecStage3Target = 0.8, 1.1, 1.4
